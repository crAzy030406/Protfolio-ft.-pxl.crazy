            ...
            <div className="bg-card rounded-3xl p-8 md:p-12">
                ...
                <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                        {skills.map((skill) => (
                        <Badge key={skill} variant="secondary" className="text-sm font-light transition-all duration-300 ease-in-out hover:shadow-lg hover:shadow-primary/50 hover:-translate-y-1">{skill}</Badge>
                        ))}
                    </div>
                    </div>
                    <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                        {software.map((tool) => (
                        <Badge key={tool} variant="secondary" className="text-sm font-light transition-all duration-300 ease-in-out hover:shadow-lg hover:shadow-primary/50 hover:-translate-y-1">{tool}</Badge>
                        ))}
                    </div>
                    </div>
                </div>
