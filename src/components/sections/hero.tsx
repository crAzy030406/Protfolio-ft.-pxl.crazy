            ...
            <div className="flex items-baseline">
              ...
              <div className="flex flex-col">
                <div className="flex items-baseline gap-2 md:gap-4">
                  ...
                  <h1 id="hero-title-2" className="text-lg sm:text-xl md:text-3xl lg:text-4xl font-normal font-headline tracking-tighter text-muted-foreground whitespace-nowrap">
                    PSYCHO DESIGNER
                  </h1>
                </div>
              </div>
