        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="z-10 flex flex-col items-center text-center md:items-start md:text-left">
            ...
            <div className="flex flex-col items-center md:items-start">
              <span 
                className="text-xl font-normal text-muted-foreground/70 md:font-bold md:text-muted-foreground md:text-2xl md:absolute md:-left-8 md:top-10 md:-rotate-90 md:transform-origin-bottom-left"
              >
                I'm
              </span>
              <div className="flex flex-col items-center md:items-start">
                <div className="flex flex-col md:flex-row md:items-baseline md:gap-4">
                  <h1 id="hero-title-1" className="text-5xl sm:text-6xl md:text-8xl lg:text-[10rem] leading-none font-bold font-headline tracking-widest">
                    CRAZY
                  </h1>
